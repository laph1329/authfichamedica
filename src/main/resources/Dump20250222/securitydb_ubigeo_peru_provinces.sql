...
CREATE TABLE `ubigeo_peru_provinces` (
  ...
  KEY `department_prov_idx` (`department_id`),
  CONSTRAINT `department_prov` FOREIGN KEY (`department_id`) REFERENCES `ubigeo_peru_departments` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
